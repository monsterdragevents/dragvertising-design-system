...
const preset = {
  "theme": {
    "extend": {
      ...
      "boxShadow": {
        "dv-sm": "0 1px 3px 0 rgba(0, 0, 0, 0.05)",
        "dv-base": "0 1px 3px 0 rgb(0 0 0 / 0.1), 0 1px 2px -1px rgb(0 0 0 / 0.1)",
        "dv-md": "0 4px 6px -1px rgba(0, 0, 0, 0.1)",
        "dv-lg": "0 10px 15px -3px rgba(0, 0, 0, 0.1)",
        "dv-xl": "0 20px 25px -5px rgba(0, 0, 0, 0.15)",
        "dv-2xl": "0 25px 50px -12px rgba(0, 0, 0, 0.25)",
